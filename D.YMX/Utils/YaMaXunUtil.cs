    ...
    public static class YaMaXunUtil
    {
        ...
        public static List<CountryEntity> Countries = new List<CountryEntity>
        {
             new CountryEntity()
            {
                ...
                Name ="中国",  Domain = "amazon.cn", Mid ="", PlanmId="",Lop="_zh_CN",
            ...
            new CountryEntity()
            {
                ...
                Name ="美国",  Domain = "amazon.com", Mid ="ATVPDKIKX0DER", PlanmId="1",Lop="en_US",
            ...
            new CountryEntity()
            {
                Name ="德国",  Domain = "amazon.de", Mid ="A1PA6795UKMFR9", PlanmId="4",Lop="en_GB",
            ...
            new CountryEntity()
            {
                Name ="墨西哥",  Domain = "amazon.com.mx", Mid ="A1AM78C64UM0Y8", PlanmId="771770",Lop="es_MX",
            ...
            new CountryEntity()
            {
                Name ="澳大利亚",  Domain = "amazon.com.au", Mid ="A39IBJ37TRP1C6", PlanmId="111172",Lop="en_AU",
            ...
            new CountryEntity()
            {
                Name ="意大利",  Domain = "amazon.it", Mid ="APJ6JRA9NG5V4", PlanmId="35691",Lop="it_IT",
            ...
            new CountryEntity()
            {
                Name ="波兰",  Domain = "amazon.pl", Mid ="A1C3SOZRARQ6R3", PlanmId="712115121",Lop="pl_PL",
            ...
            new CountryEntity()
            {
                Name ="西班牙",  Domain = "amazon.es", Mid ="A1RKKUPIHCS9HS", PlanmId="44551",Lop="es_ES",
            ...
            new CountryEntity()
            {
                Name ="阿联酋",  Domain = "amazon.ae", Mid ="A2VIGQ35RCS4UG", PlanmId="338801",Lop="en_AE",
            ...
            new CountryEntity()
            {
                Name ="加拿大",  Domain = "amazon.ca", Mid ="A2EUQ1WTGCTBG2", PlanmId="7",Lop="en_CA",
            ...
            new CountryEntity()
            {
                Name ="印度",  Domain = "amazon.in", Mid ="A21TJRUUN4KGV", PlanmId="44571",Lop="en_IN",
            ...
            {
                Name ="法国",  Domain = "amazon.fr", Mid ="A13V1IB3VIYZZH", PlanmId="5",Lop="fr_FR",
            ...
            {
                Name ="瑞典",  Domain = "amazon.se", Mid ="A2NODRKZP88ZB9", PlanmId="704403121",Lop="sv_SE",
            ...
            {
                Name ="荷兰",  Domain = "amazon.nl", Mid ="A1805IZSGTT6HS", PlanmId="328451",Lop="nl_NL",
            ...
            {
                Name ="英国",  Domain = "amazon.co.uk", Mid ="A1F83G8C2ARO7P", PlanmId="3",Lop="en_GB",
            ...
            {
                Name ="日本",  Domain = "amazon.co.jp", Mid ="A1VC38T7YXB528", PlanmId="6",Lop="zh_CN",
            ...
            new CountryEntity()
            {
                Name ="巴西",  Domain = "amazon.com.br", Mid ="", PlanmId="",Lop="",
            ...
            {
                Name ="土耳其",  Domain = "amazon.com.tr", Mid ="", PlanmId="",Lop="",
            ...
            ,new CountryEntity()
            {
                Name ="比利时",  Domain = "amazon.com.be", Mid ="", PlanmId="",Lop="",
            ...
            {
                Name ="沙特",  Domain = "amazon.sa", Mid ="", PlanmId="",Lop="",
            ...
            {
                Name ="新加坡",  Domain = "amazon.sg", Mid ="", PlanmId="",Lop="",
